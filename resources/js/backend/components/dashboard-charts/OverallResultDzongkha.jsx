...
import ConstituencyWinsChart from "./ConstituencyWinsChart";
...
function OverallResultDzongkha() {
    const [loading, setLoading] = useState(true);
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                setData(response.partyWinsCount); // Assuming the data is in the 'data' property of the response
            } catch (error) {
                console.error("Error fetching data:", error);
            } finally {
                setLoading(false);
                                        ...
                                        data.map((item) => (
                                            <div className="constituency-chart-frame">
                                                ...
                                                <div className="votes-container">
                                                    <div
                                                        className="constituency-value"
                                                        style={{
                                                            backgroundColor:
                                                                item.color_code,
                                                        }}
                                                    >
                                                        <span className="constituency-value-text">
                                                            {item.value}
                                                        </span>
                                                    </div>
                                                    <div className="constituency-label">
                                                        འདེམས་ཁྲི་ཡོངས་བསྡོམས།
                                                    </div>
                                                </div>
                                            </div>
...
export default OverallResultDzongkha;
